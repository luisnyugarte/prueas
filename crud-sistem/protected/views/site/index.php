        ...
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-11 col-md-12">
                    ...
                    <h3>¿Que es CRUD?</h3>
                        <p>
                             En programación informática, crear, leer, actualizar y eliminar (CRUD) son las cuatro funciones básicas de almacenamiento persistente . A veces CRUD se amplía con las palabras recuperaren lugar de leer o destruir en vez de eliminar . A veces también se utiliza para describir la interfaz de usuario convenciones que facilitan la visualización, búsqueda, y el cambio de la información , a menudo utilizando equipo basado en las formas y los informes .
                         </p>
                    <h3>¿Que es YII?</h3>
                        <p>
                    ...
                    <p class="center-block download-buttons">
                        <a href="?r=cliente/create/" class="btn btn-primary btn-lg">Comenzar</a>
                    </p>
                </div>
